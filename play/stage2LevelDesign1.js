...
var stage2LevelDesign1 = function(game){}
// Creates a new 'main' state that will contain the game
	stage2LevelDesign1.prototype = {
		preload: function() { 
		...
		create: function() { 
			...
			coinsText = game.add.text(game.width/1.5,30,"Coins Collected - ",{
			...
			timerText = game.add.text(game.width/1.3,10,"Remaining Time - 0",{
				font:"bold 16px Arial", fill: "red" 
			});
